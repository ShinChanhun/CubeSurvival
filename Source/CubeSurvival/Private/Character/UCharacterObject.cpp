...
TMap<FString, USkeletalMesh*> UUCharacterObject::GetMonsterMesh() const
{
	return MonsterMesh;
}

TMap<FString, class TSubclassOf<UAnimInstance> > UUCharacterObject::GetNormalMonsterAnim() const
{
